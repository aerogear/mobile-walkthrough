...
:data-sync-name: RHMI Data Sync
:data-sync-showcase-app: Data Sync showcase application
:customer-sso-name: End user SSO instance

= About this solution pattern

RHMI Data Sync is a framework that helps developers build applications that can perform realtime data synchronization with GraphQL.
