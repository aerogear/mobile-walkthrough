...
* How to deploy the data sync server of the mobile showcase app to show data sync related features.
* How to protect the showcase mobile app and the backend service using the Identity Management service.
* How to gain insights of the showcase app using the Mobile App Metrics service, including app and device info, device security info and service metrics.
...
=== Add Identity Management service to the data sync server
