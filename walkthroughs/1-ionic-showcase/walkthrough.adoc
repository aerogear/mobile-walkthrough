...
It will also introduce you to all features offered by the data sync framework.
...
* link:https://access.redhat.com/documentation/en-us/red_hat_codeready_workspaces[Documentation, window="_blank"]
****
...
. Go to https://github.com/aerogear/ionic-showcase git repository
. Clone repository to local machine `git clone git@github.com:aerogear/ionic-showcase.git`
. Execute `npm install` to install dependencies 
. TODO - wrap app into docker image or.. run it localy as we do in modern-app-dev workshop
