...
The showcase app is displayed. Note the URL of the PWA.
...
. Navigate to link:{che-url}[CodeReady Console, window="_blank"] and open the workspace for the showcase app that we have created in one of the previous steps.
