...
. Using the Chrome browser:
.. Check that the task changes appear.
...
.. Simulate offline mode. In Firefox, select *Work Offline* from the *Web Developers* menu.
.. Create a new task.
...
You do not see any of the changes from the firefox browser.
...
. Using the Chrome browser:
.. Log into the showcase app.
.. Simulate offline mode. In Chrome, press F12 to open *Developer Tools* and select *offline* in  the *Network* tab.
...
+
----
Conflicting description from chrome browser
----
