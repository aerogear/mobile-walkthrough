...
. Select the `src/mobile-services.json` file.
. Paste contents from the Mobile Developer Console you saved earlier.
The file is automatically saved. 

. Choose *build* from the *Commands Pallette* (Shift F10).
