...
:data-sync-name: Red Hat Data Sync
:data-sync-showcase-app: Data Sync showcase application
:customer-sso-name: End user SSO instance

= About this solution pattern

Red Hat Data Sync is a framework that helps developers build applications that can perform realtime data synchronization with GraphQL.
...
.Red Hat Data Sync Documentation
****
* link:https://access.redhat.com/documentation/en-us/red_hat_build_of_node.js/10/html-single/node.js_runtime_guide/index[Getting Started with {data-sync-name}, window="_blank"]
****
