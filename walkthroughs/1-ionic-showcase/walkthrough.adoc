...
. Make sure you have access to a realm in the link:{sso-realm-url}[SSO Realm, window="_blank"]. If you do not, you can ask your customer-admin user to create one for you. 
. Login to the realm in the link:{sso-realm-url}[SSO Realm, window="_blank"].
